...
if(e_QUERY == "v"){
	$ns -> tablerender("", "<div style=\"text-align:center\"><b>Emoticon added.</b></div>");
}

if(e_QUERY == "w"){
	$ns -> tablerender("", "<div style=\"text-align:center\"><b>Emoticon deleted.</b></div>");
}
...
<table width='85%'>
<tr> 
<td style=\"width:30%\" class=\"forumheader3\">Activate emoticons?: </td>
...
<tr> 
<td rowspan='".count($emote)."' class=\"forumheader3\" style=\"vertical-align:top\">Emoticons</td>";
$c=0;
while(list($short, $name) = @each($emote[$c])){
	...
	<td style=\"width:10%; text-align:center\" class=\"forumheader3\"><img src=\"".e_BASE."themes/shared/emoticons/$name\" alt=\"\" style=\"vertical-align:absmiddle\" /></td>
	<td style=\"width:30%\" class=\"forumheader3\">[ <a href='".e_SELF."?del.$c'>Delete</a> ]</td>
	</tr>";
	$c++;
}
$text .= "<tr> 
...
<input class=\"button\" type=\"submit\" name=\"addemote\" value=\"Add New Emote\" />
</td>
</tr>
</table>
</form>
