...
class ConfigurationTest extends \Codeception\Test\Unit
{
	...
	public function testSetParentDestroysChildren()
	{
		$configuration = self::makeConfiguration();
		$expected = [
			'a' => [
		...
		$configuration->set('a/b/c/d/e', 'Old Pop In An Oak');
		$output = $configuration->set('a/b', 'override');
	...
	public function testGet()
	{
		...
		$this->assertEquals($data, $configuration->get());
		$this->assertEquals($data, $configuration->get(false));
		$this->assertEquals($data, $configuration->get(null));
