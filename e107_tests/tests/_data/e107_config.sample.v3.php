 ...
 * @var array $database = [
 *     // Common options
 *     'driver' => 'string', // Case-insensitive driver name
 *                           // ({@see \e107\Configuration\Site\SiteDatabaseConfiguration::getDriver()})
 ...
 *
 *     // Options for mysql
 *     'socket' => 'string', // Instead of a host and a port, the path of a UNIX socket used to connect to MySQL
 * ]
 */
$database = [
    // Required options
