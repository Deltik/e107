...
if(file_exists("../../../class2.php")){require_once("../../../class2.php");}
else{require_once("../../../../class2.php");}
...
$IMConfig['base_url'] = SITEURL.$IMAGES_DIRECTORY;
...
$IMConfig['safe_mode'] = (ini_get('safe_mode'))? "true" : "false";
/*
