...
//			user_chats int(10) unsigned NOT NULL default '0',
	...
	*/
	 ...
	 * @return string The contents of the login token (not cryptographically secure!)
	 * @todo since v2.4.0, $autologin should be rewritten as a user-defined session lifetime
	 */
	public function makeUserCookie($lode, $autologin = false)
	{
		$cookieval = $lode['user_id'] . '.' . md5($lode['user_password']);
		return $_SESSION[e107::getPref('cookie_name')] = $cookieval;
	}
