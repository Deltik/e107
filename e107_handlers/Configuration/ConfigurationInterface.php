...
interface ConfigurationInterface
{
	 ...
	 *
	 * Due to the lack of type enforcement, this method should only be called within an implementation of
	 * {@link ConfigurationInterface} rather than by any client code.
	 *
	 * @param string $key
