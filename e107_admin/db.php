...
<td style='width:30%' class='forumheader3' style='text-align:center'><input class='button' type='submit' name='verify_sql' value='".DBLAN_5."' /></td>
</tr>

<tr>
<td style='width:70%' class='forumheader3'>".DBLAN_6."</td>
<td style='width:30%' class='forumheader3' style='text-align:center'><input class='button' type='submit' name='optimize_sql' value='".DBLAN_7."' /></td>
</tr>

<tr>
<td style='width:70%' class='forumheader3'>".DBLAN_8."</td>
<td style='width:30%' class='forumheader3' style='text-align:center'><input class='button' type='submit' name='backup_core' value='".DBLAN_9."' /></td>
</tr>
