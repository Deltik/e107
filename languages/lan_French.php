...
//define(LAN_10, "Shortcut tags allowed: [b] [i] [u] [img] [cen] [bq]<br />use [link] url [/link] for links<br />Line breaks (< br />) are auto added.");
 ...
 define(LAN_10, "Tags permis: [b] [i] [u] [img] [cen] [bq]<br />Utiliser [link] votre url [/link] pour les liens<br />Les retours à la ligne (< br />) sont identifiés automatiquement.");
...
//define(LAN_13, "News story deleted.");
 ...
 define(LAN_13, "Nouvelle effacée.");

//define(LAN_14, "News updated in database.");

 define(LAN_14, "Nouvelle mise à jour.");

//define(LAN_15, "News entered into database.");

 define(LAN_15, "Nouvelle ajoutée.");
...
//define(LAN_19, "Unable to write news.xml file to server, please ensure the /backend directory has the correct permissions set (666)");
 ...
 define(LAN_19, "Impossible d'écrire sur le fichier news.xml, veuillez contrôler les permissions (666) du dossier /backend ");
...
//define(LAN_24, "fuck|piss|shit|cunt|cock|asshole|motherfucker|mother fucker| arse|pussy|faggot");
 ...
 define(LAN_24, "putain|pisse|merde|cunt|bite|trou du cul|fils de pute|enculé| arse|chatte|faggot");

//define(LAN_25, "Previous page");

 define(LAN_25, "Page précédente");
...
//define(LAN_27, "You left required fields blank");
 ...
 define(LAN_27, "Vous avez oublié de remplir des champs obligatoires");

//define(LAN_28, "Err you didn't post anything ..");

 define(LAN_28, "Erreur, vous avez oublié d'entrer le moindre mot ..");
...
//define(LAN_36, "You last visit visited at ");
 define(LAN_36, "Votre dernière visite remonte à ");
...
//define(LAN_43, "These forums can be browsed and posted to by non-registered users, but if you wish to see info related to new posts, edit/delete your posts etc you will have to <a href="signup.php">register</a> and log in.");
 define(LAN_43, "Vous pouvez visiter et poster sur ces forums sans vous enregistrer. Mais si vous voulez bénéficier de tous les atouts du forum, vous devez vous identifier <a href=\"signup.php\">ici</a>.");

//define(LAN_44, "These forums can be browsed and posted to by non-registered users, ip addresses and host will be logged.");

 define(LAN_44, "Vous pouvez visiter et poster sur ces forums sans vous enregistrer. Cependant votre adresse IP sera enregistré afin d'éviter certains abus.");
...
//define(LAN_54, "Starter");
 define(LAN_54, "Démarreur");

//define(LAN_55, "Replies");
 define(LAN_55, "Réponses");
...
//define(LAN_60, "Start New Thread");
 ...
 define(LAN_60, "Débuter un nouveau fil");
...
//define(LAN_65, "Admin detected - moderation switched on");
 define(LAN_65, "Admin detecté - moderation enclenché");

//define(LAN_66, "This thread is now closed");
 define(LAN_66, "Ce fil est maintenant fermé");
...
//define(LAN_70, "move");
 define(LAN_70, "déplacer");

//define(LAN_71, "No replies.");
 define(LAN_71, "Aucune réponse.");

//define(LAN_72, "Originally posted by");
 define(LAN_72, "Posté par");

//define(LAN_73, "Reply: ");
 define(LAN_73, "Réponse: ");

//define(LAN_74, "Reply to thread");
 define(LAN_74, "Répondre au fil");

//define(LAN_75, "Post Reply");
 define(LAN_75, "Poster votre réponse");

//define(LAN_76, "Reply");
 define(LAN_76, "Répondre");

//define(LAN_77, "Update Thread");
 define(LAN_77, "Mis à jour du fil");

//define(LAN_78, "Update Reply");
 define(LAN_78, "Mis à jour de la réponse");
...
//define(LAN_88, "Referals:");
 define(LAN_88, "Référants:");

//define(LAN_89, "Admin: ");
 define(LAN_89, "Admin: ");

//define(LAN_90, "add new link in this category");
 define(LAN_90, "ajouter des nouveaux liens dans cette catégorie");

//define(LAN_91, "add new category");
 define(LAN_91, "ajouter de nouvelles catégories");
...
//define(LAN_105, "The two passwords do not match, please re-enter.");
 ...
 define(LAN_105, "Vous avez entrer deux mots de passe différants, veuillez les ré-entrer.");

//define(LAN_106, "That doesn't appear to be a valid email address, please re-enter.");

 define(LAN_106, "Cet e-mail ne semble pas être valide, veuillez le ré-entrer.");
...
//define(LAN_107, "Thankyou! You are now a registered member of ".SITENAME.", please keep your username and password written down in a safe place as if lost they cannot be retrieved.<br /><br />You can now login from the Login box.");
 ...
 define(LAN_107, "MERCI! Vous faites maintenant partie de la communauté du ".SITENAME.". Un bon conseil, notez votre identifiant et votre mot de passe dans un lieu sûr.<br /><br />Vous pouvez dès à présent vous identifier !.");
...
//define(LAN_109, "This site complies with The Children's Online Privacy Protection Act of 1998 (COPPA) and as such cannot accept registrations from users under the age of 13 without a written permission document from their parent or guardian. For more information you can read the legislation <a href="http://www.cdt.org/legislation/105th/privacy/coppa.html">here</a>. Please contact the main site admin <a href="mailto:".SITEADMINEMAIL."">here</a> if you require assistance.<br /><br /><div style="text-align:center"><b>If you are over the age of 13 please click <a href="signup.php?stage1">here</a> to continue the registration process.");
 ...
 define(LAN_109, "Ce site adhère aux principes du <b>The Children's Online Privacy Protection Act of 1998 (COPPA)</b>. Dès lors, nous ne pouvons accepter votre enregistrement si vous n'avez pas 13 ans révolus ou une permission écrite de vos parents. Pour plus d'informations, merci de vous référer sur le site de la COPPA <a href=\"http://www.cdt.org/legislation/105th/privacy/coppa.html\">ici</a>. En cas de problème, merci de contacter le webmaster du site <a href=\"mailto:".SITEADMINEMAIL."\">ici</a>.<br /><br /><div style=\"text-align:center\"><b>Si vous avez 13 ans révolus, veuillez cliquer <a href=\"signup.php?stage1\">ici</a>.");
...
//define(LAN_114, "(This will prevent your email address from being displayed)");
 define(LAN_114, "(Ceci préservera votre e-mail de la vue de tous)");
...
//define(LAN_134, "Your item has been submitted and will be reviewed by one of the site administrators in due course.");
 define(LAN_134, "Votre proposition a bien été transmise et sera examinée ASAP.");
...
//define(LAN_138, "Registered members: ");
 define(LAN_138, "Membres enregistrés: ");
...
//define(LAN_150, "Settings updated.");
 define(LAN_150, "Préférences mises à jour.");
...
//define(LAN_154, "Update Settings");
 define(LAN_154, "Préférences mise à jour");

//define(LAN_155, "Update User Settings");
 define(LAN_155, "Mise à jour des préfences des utilisateurs");

//define(LAN_185, "You left the password field blank,");
 define(LAN_185, "Vous avez oublié d'entrer votre mot de passe");
...
//define(LAN_168, "Our headlines can be syndicated by using either our rss or text feeds.");
 define(LAN_168, "Vous pouvez reprendre nos headlines grâce à ces deux fichiers: rss ou txt.");
...
//define(LAN_171, "Unique user id not recognised (possible corrupted cookie).<br />Please <a href="index.php?logout">click here</a> to destroy cookie.");
 ...
 define(LAN_171, "Le site ne peut reconnaître votre ID(un cookie dégradé probablement).<br />Veuillez vous <a href=\"index.php?logout\">déconnecter</a>.");

//define(LAN_172, "Logout");
 define(LAN_172, "Déconnexion");
...
//define(LAN_178, "Logged in users: ");
 define(LAN_178, "Membres enregistrés: ");
...
//define(LAN_192, "The users of this forum have posted a total of ");
 define(LAN_192, "Les utilisateurs de ce forum on posté un total de ");

//define(LAN_193, "Forum Moderator");
 define(LAN_193, "Modérateur du forum");
...
//define(LAN_203, "Sticky/Closed thread");
 define(LAN_203, "Fil Fermé/Collant");

//define(LAN_204, "You <b>can</b> start new threads");
 define(LAN_204, "Vous <b>pouvez</b> démarrer un nouveau fil");

//define(LAN_205, "You <b>cannot</b> start new threads");
 define(LAN_205, "Vous <b>ne pouvez pas</b> démarrer un nouveau fil");

//define(LAN_206, "You <b>can</b> post replies");
 define(LAN_206, "Vous <b>pouvez</b> poster des réponses");

//define(LAN_207, "You <b>cannot</b> post replies");
 define(LAN_207, "Vous <b>ne pouvez pas</b> poster des réponses");

//define(LAN_208, "You <b>can</b> edit your posts");
 define(LAN_208, "Vous <b>pouvez</b> éditer vos messages");

//define(LAN_209, "You <b>cannot</b> edit your posts");
 define(LAN_209, "Vous <b>ne pouvez pas</b> éditer vos messages");
...
//define(LAN_213, "That username/email address was not found in database.");
 define(LAN_213, "Ce nom d'utilisateur ou cette adresse n'a pas été trouvé dans la base de données.");

//define(LAN_214, "Unable to reset password");
 define(LAN_214, "Impossible de redéfinir le mot de passe");

//define(LAN_215, "Your password for ".SITENAME." has been reset. Your new password isnn");
 define(LAN_215, "Votre mot de passe pour ".SITENAME." a été redéfinit. Votre nouveau mot de passe est");
...
//define(LAN_217, "Thankyou, your new password is now validated. You may now login using your new password.");
 define(LAN_217, "Merci, votre nouveau mot de passe est maintenant validé. Vous pouvez utiliser votre nouveau mot de passe pour vous identifier.");
