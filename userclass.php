...
if(IsSet($_POST['updateclass'])){
	...
	echo "<div style='text-align:center'><b>Classes updated.</b><br />";
	$sql -> db_Select("user", "user_name", "user_id='$id' ");
	$row = $sql -> db_Fetch();
	if($_POST['notifyuser']){
		echo "<b> sending notification email to:</b> ".$row['user_name']."<br />";
	}
	echo "<br /></div>";
}
...
if($_POST['notifyuser']){
	...
	$send_to = $user_email;
	$subject = "Updated Privelages";
	$message = "Dear " . $user_name. ",\n\n";
	$message .= "Your privelages have been updated at ".SITENAME."\n";
	$message .= "( ".SITEURL . " )\n\n" ;
	$message .= "You now have access to the following area(s): \n\n";
	$message .= $messaccess . "\n";
      //    $message .= "<a href=\"".SITEURL."\">Please click here to go there now</a><br /><br />";
	$message .= "Thanks\n" . SITEADMIN . "\n";
	$message .= "( " . SITENAME . " )";
...
$text .= "<tr><td colspan='2' style='text-align:center'><br /><input type='checkbox' name='notifyuser' value='1' /> Notify User</td></tr>";
