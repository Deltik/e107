...
$temp = mysql_query("SELECT sum(counter_total) FROM ".MPREFIX."stat_counter WHERE counter_url='".$_SERVER['PHP_SELF']."' ");
$temp = mysql_fetch_array($temp);
$total_page_views = $temp[0];
$temp = mysql_query("SELECT sum(counter_unique) FROM ".MPREFIX."stat_counter WHERE counter_url='".$_SERVER['PHP_SELF']."' ");
$temp = mysql_fetch_array($temp);
